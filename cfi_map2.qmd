...
ests <- compute_summary_mainlevel_1g(indicators, groups, data = main_data, weights = "weight_msme", psu = NULL, keep = NULL)
...
ests <- compute_summary_mainlevel_1g(indicators, groups, data = main_data %>% filter(resp_type_owner == 1), weights = "weight_msme", psu = NULL, keep = "mean") %>% mutate(indicator_name = ifelse(indicator_name == "Household", "Business operates from household premises", indicator_name))

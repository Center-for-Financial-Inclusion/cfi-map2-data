...
scales <- list(
 ...
 facets <- list(type = "grid", cols ="depvar_label", rows = "model_type", scales = "free", space = "free") 
...
scales <- list(
 ...
 facets <- list(type = "grid", rows ="depvar_label", cols = "model_type", scales = "free", space = "free") 

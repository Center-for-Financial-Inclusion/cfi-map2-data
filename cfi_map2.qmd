...
labels <- list(
  ...
  subtitle = "Mean sales and standardized daily sales per worker",
  yax_ti = NULL,
  xax_ti = NULL,
...
labels <- list(
  title = "Depth of digital applications used by MSEs",
  subtitle =  "MSEs (%)",
  yax_ti = NULL,
  xax_ti = NULL,
  caption = str_wrap(paste(SOURCE, fig_notes), CAP_WRAP)
...
fig_data <- prep_reg_data(prep_reg_factors(ests, factor_params, include_valuelabel = FALSE), depvarlog = TRUE) %>% 
 ...
 labels <- list(
      title = "Observational estimates of the effect of the depth of digital technology adoption on labor productivity",
      subtitle = "",
      y = NULL,
      x = NULL,
      caption = str_wrap(paste(SOURCE, fig_notes), CAP_WRAP)

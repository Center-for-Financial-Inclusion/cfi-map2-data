...
::: {.cell .caption-margin}
::: {.cell-output-display}
![Relationship between depth of digital technology adoption and exposure to consumer protection risks](cfi_map2_global_files/figure-html/fig-reg_cp_digtech-1.png){#fig-reg_cp_digtech width=1152}
:::
:::

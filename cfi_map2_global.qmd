...
palette <- c("#A2C3A4", "#C4F1BE", "#FF9F1C", "#41BBD9", "#CEE5F2", "#BFD3C1", "#A2C3A4", "#C4F1BE", "#CEE5F2", "#FF7B9C", "#CEE5F2", "#FF7B9C")
...
labels <- list(
  title = "Total number of formal financial devices used by category",
...
indicators <- c("fin_account_formal", "fin_account_formal_usgdef", "fin_owner_save", names(main_data_all)[str_detect(names(main_data_all), "bus_savings_agg|bus_savings_channel")])
groups_l1 <- "city"
groups_l2 <- GROUPS[c("resp_sex_str")]
